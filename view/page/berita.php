...
<div class="hero2 position-relative">
  ...
  <!-- Teks di Tengah -->
<div class="hero-text position-absolute text-white text-center">    <h1 class="fw-bold display-4">Berita</h1>
...
<div class="hero2">
      <div class="news-container" data-aos="fade-down" data-aos-duration="1000">
        ...
        <!-- Kolom Kiri: Card Berita -->
                ...
                <!-- pagination -->
                <div class="pagination-wrapper" aria-label="Page navigation example">
        ...
        <div class="news-sidebar">
            ...
            <input type="text" placeholder="Kata Kunci Pencarian Judul Berita">
            <button>CARI</button>
            <ul>
            ...
            <li><a href="#">Lintas Pulau</a></li>
            <li><a href="#">Pariwisata</a></li>
            <li><a href="#">Umum</a></li>
            <li><a href="#">Pendidikan dan Kesehatan</a></li>
