...
<html lang="en">
  <head>
    ...
    <base href="<?= $domain ?>/WebsitePulo1000/"/>
...
=======
>>>>>>> c2fff43f1f5cd202a7404d12ee74e15da2a76963
  ...
  <body>
    <div class="loading">
      <div class="loader">
        <img src="public/assets/images/loading.png" alt="Loading..." />
        <div class="dots">
          <span></span>
          <span></span>
          <span></span>
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu">
                ...
                <li class="nav-item dropend">
                  ...
                  <ul class="dropdown-menu">
                    <li>
                      <a class="dropdown-item" href="pages/kel_untung_jawa.php" id="sub-dropdown">KEL. UNTUNG JAWA</a>
                    </li>
