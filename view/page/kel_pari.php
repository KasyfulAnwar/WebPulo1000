...
<div class="hero-text position-absolute text-white text-center">
    <h1 class="fw-bold display-4">Pulau Pari</h1>
  ...
  <div class="row">
    <div class="col-md-6">
      ...
      <div class="profile-card">
        ...
        Luas batas wilayah Kelurahan Pulau Pari secara geografis dapat dilihat sebagai berikut :+94.57 Ha.
          <ul>
            <li>Sebelah Utara : 05046’15”LS</li>
            <li>Sebelah Timur : 106034’00”BT</li>
            <li>Sebalah Selatan : 05059’50”LS</li>
            <li>Sebelah Barat : 106034’22”BT</li>
            <li>Ketinggian tanah dari permukaan laut : 1 s/d 2 meter</li>
            <li>Suhu udara rata-rata : 27°c - 32°</li>
            <li>Jarak dari Kantor Kec. Kep. Seribu Selatan : 17.65 Km</li>
            <li>Jarak dari Kantor Kab. Adm. Kep. Seribu : 20.29 Km</li>
            <li>Jarak dari Pemerintahan Provinsi DKI Jakarta : 39 Km</li>
    ...
    <div class="col-md-6">
      ...
      <div class="profile-card">
        ...
        <div class="divider"></div>
        <div class="section-content">
        Berdasarkan Keputusan Gubernur Provinsi DKI Jakarta Nomor 1986 Tahun 2000, luas wilayah Kelurahan Pulau Pari adalah +94.57 Ha dengan jumlah pulau sebanyak 12 pulau.
          <ul>
            <li>Selanjutnya ditinjau dari segi pembagian lingkungan masyarakat yaitu lingkungan RT dan RW terdiri dari Jumlah RT : 14 dan Jumlah RW : 4 yang berada di dua Pulau yaitu Pulau Lancang Besar dan pulau Pari.</li>
            <li>Berdasarkan peruntukan dan penggunaan pulau yang ada 5 pulau peruntukannya untuk PHB, 1 pulau diperuntukan untuk PHU, 4 pulau diperuntukan Pariwisata, 1 pulau pemukiman. 1 pulau 10 % PHB 40 % Perum 50 % Pariwisata ( pulau pari).</li>
          </ul>
        </div>
      </div>
    </div>
...
<div class="container mt-5" style="margin-bottom: 50px">
  <div class="row">
    ...
    <div class="col-md-4 text-center">
      <img src="./public/asset/photo/lurah_pari.png" alt="sidartawan" class="profile-image" />
    </div>
    <!-- Deskripsi Profil (kanan) -->
    <div class="col-md-8">
      <div class="profile-text">
        <h3>Muhamad Adriansyah</h3>
        <p id="lurah">Lurah Pari</p>
