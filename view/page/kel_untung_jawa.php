...
<div class="hero2 position-relative">
  ...
  <div class="hero-fixed">
    <img src="./public/asset/img/p_untungjawa.jpg" alt="Hero Pariwisata" style="width: 100%; height: 50vh; object-fit: cover, box-shadow: 0 10px 20px rgba(0, 0, 0,0.5);" />
  </div>

  <!-- Teks di Tengah -->
<div class="hero-text position-absolute text-white text-center">
    <h1 class="fw-bold display-4">Pulau Untung Jawa</h1>
  ...
  <div class="row">
    ...
    <div class="col-md-8">
      <div class="profile-text">
        <h3>Sidartawan, MM</h3>
        <p id="lurah">Lurah Untung Jawa</p>
...
<div class="container" style="height: 100vh; display: flex; justify-content: center">
  <iframe
    width="1000px"
    height="700px"
    src="https://lookerstudio.google.com/embed/reporting/7c3d0b68-e5cd-4b66-9877-eb870c007acc/page/p_7rfp1hj1rd"
    frameborder="0"
    style="border: 0"
    allowfullscreen
