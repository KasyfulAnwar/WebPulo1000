...
<div class="hero2 position-relative">
  ...
  <div class="hero-text position-absolute top-50 start-50 translate-middle text-white text-center">
    <h1 class="fw-bold display-4">Kecamatan Seribu Selatan</h1>
  ...
  <div class="row">
    ...
    <div class="col-md-6">
      ...
      <div class="profile-card">
        ...
        <div class="section-content">
          <ul>
            <li>Pada tahun 2017, Kecamatan ini memiliki penduduk sebesar 10.231 jiwa yang terdiri dari 4.858 laki-laki dan 4.754 perempuan dengan seks rasio 102,18.</li>
          </ul>
        </div>
      </div>
    </div>
    ...
    <div class="col-md-4">
      <a href="./view/page/kel_pari.php" class="card-link">
        <div class="card text-center p-4 card-hover">
          ...
          <div class="card-body">
            <h5 class="card-title">Kelurahan Pulau Pari</h5>
          </div>
        </div>
      </a>
    </div>
    <div class="col-md-4">
      <a href="./view/page/kel_tidung.php" class="card-link">
        <div class="card text-center p-4 card-hover">
          <i class="bi bi-bank icon-style text-success"></i>
          <div class="card-body">
            <h5 class="card-title">Kelurahan Pulau Tidung</h5>
          </div>
        </div>
      </a>
    </div>
    <div class="col-md-4">
      <a href="./view/page/kel_untung_jawa.php" class="card-link">
        <div class="card text-center p-4 card-hover">
          <i class="bi bi-bank icon-style text-success"></i>
          <div class="card-body">
            <h5 class="card-title">Kelurahan Pulau Untung Jawa</h5>
          </div>
        </div>
      </a>
    </div>
  ...
  <div class="row">
    ...
    <div class="col-md-8">
      <div class="profile-text">
        <h3>Denny Harnoko. SH. MM</h3>
        <p id="lurah">PLT Camat Seribu Selatan</p>
  ...
  <div class="row row-cols-1 row-cols-md-4 g-4">
    ...
    <div class="col">
      <div class="laporan-card">
        <div class="d-flex flex-wrap gap-2 meta-info mb-2">
          <div><i class="fas fa-user"></i> Camat Selatan</div>
          <div><i class="fas fa-folder-open"></i> Publikasi</div>
          <div><i class="fas fa-calendar-alt"></i> 11 Des 2023</div>
        </div>
        <div class="laporan-title">Standar Pelayanan 2023</div>
        <div class="laporan-desc">Dokumen resmi pelayanan Kecamatan Kepulauan Seribu Selatan</div>
        <a href="doc_sp/standar_pelayanan_selatan.pdf" style="margin-top:70px" class="btn-download"><i class="fas fa-download"></i> Download disini</a>
      </div>
    </div>
    ...
    <div class="col">
      <div class="laporan-card">
        ...
        <div class="laporan-title">Survey Kepuasan Masyarakat</div>
        <div class="laporan-desc">Laporan SKM Kecamatan Seribu Selatan Semester 1 Tahun 2024</div>
        <a href="doc_sp/skm_selatan.pdf" style="margin-top:65px" class="btn-download"><i class="fas fa-download"></i> Download disini</a>
      </div>
    </div>
    ...
    <div class="col">
      <div class="laporan-card">
        <div class="d-flex flex-wrap gap-2 meta-info mb-2">
          ...
          <div><i class="fas fa-folder-open"></i> Publikasi</div>
          <div><i class="fas fa-calendar-alt"></i> 21 Juli 2023</div>
        </div>
        <div class="laporan-title">Rencana Kerja Perangkat Daerah | 2024</div>
        <div class="laporan-desc">Rencana Kerja Perangkat Daerah Kabupaten Adm. Kepulauan Seribu Tahun 2024</div>
        <a href="doc_sp/renja_seribu.pdf" class="btn-download"><i class="fas fa-download"></i> Download disini</a>
      </div>
    </div>
    ...
    <div class="col">
      <div class="laporan-card">
        <div class="d-flex flex-wrap gap-2 meta-info mb-2">
          <div><i class="fas fa-user"></i> Kabupaten Pulau Seribu</div>
          <div><i class="fas fa-folder-open"></i> Publikasi</div>
          <div><i class="fas fa-calendar-alt"></i> Jan 2024</div>
        </div>
        <div class="laporan-title">Perjanjian Kinerja | 2024</div>
        <div class="laporan-desc">Perjanjian Kinerja Tahun 2024</div>
        <a href="doc_sp/perjanjian_kinerja.pdf" style="margin-top:110px" class="btn-download"><i class="fas fa-download"></i> Download disini</a>
      </div>
    </div>
    ...
    <div class="col">
      <div class="laporan-card">
        ...
        <div class="laporan-title">Hasil Survey Kepuasan Masyarakat | 2024
        </div>
        <div class="laporan-desc">Hasil Survei Kepuasan Masyarakat Kota / Kabupaten Administrasi DKI Jakarta Semester 2 - Tahun 2024</div>
        <a href="doc_sp/skm_selatan2.pdf" class="btn-download"><i class="fas fa-download"></i> Download disini</a>
      </div>
    </div>
    ...
    <div class="col">
      <div class="laporan-card">
        ...
        <div class="laporan-title">Hasil Survey Kepuasan Masyarakat | 2024</div>
        <div class="laporan-desc">Hasil Survei Kepuasan Masyarakat Kota / Kabupaten Administrasi DKI Jakarta Semester 1 - Tahun 2024</div>
        <a href="doc_sp/skm_selatan3.pdf" class="btn-download"><i class="fas fa-download"></i> Download disini</a>
      </div>
    </div>
    ...
    <div class="col">
      <div class="laporan-card">
        <div class="d-flex flex-wrap gap-2 meta-info mb-2">
          <div><i class="fas fa-user"></i> Kabupaten Pulau Seribu</div>
          <div><i class="fas fa-folder-open"></i> Publikasi</div>
          <div><i class="fas fa-calendar-alt"></i> 7 Nov 2024</div>
        </div>
        <div class="laporan-title">Hasil Survey Kepuasan Masyarakat | 2023</div>
        <div class="laporan-desc">Hasil Survei Kepuasan Masyarakat Kota / Kabupaten Administrasi DKI Jakarta Semester 2 - Tahun 2023</div>
        <a href="doc_sp/skm_selatan4.pdf" class="btn-download"><i class="fas fa-download"></i> Download disini</a>
      </div>
    </div>
    ...
    <div class="col">
      <div class="laporan-card">
        ...
        <div class="laporan-title">Laporan Kinerja Pemerintah | 2023</div>
        <div class="laporan-desc">Laporan Kinerja Instansi Pemerintah Tahun 2023</div>
        <a href="doc_sp/laporan_kinerja.pdf" style="margin-top:83px" class="btn-download"><i class="fas fa-download"></i> Download disini</a>
      </div>
    </div>
